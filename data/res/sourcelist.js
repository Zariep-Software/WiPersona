...
export const LocalBackground = "url('res/background.webp')";
export const LocalAvatarSpeak = "res/speak.webp";
export const LocalAvatarSilence = "res/silence.webp";
export const LocalAvatarScream = "res/scream.webp";